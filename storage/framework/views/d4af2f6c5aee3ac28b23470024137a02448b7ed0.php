                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('admin.about.update')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" class="form-control" name="title_en" id="title_ml" value="<?php echo e($about->title_en); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" class="form-control" name="title_ml" id="title_ml" value="<?php echo e($about->title_ml); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-5">
                                                    <img id="new_main_image" src="<?php echo e(asset('frontend/assets/images/about/' . $about->main_image)); ?>" style="width:230px;height:172px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <textarea id="summernote1" name="description_en"><?php echo e($about->description_en); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <textarea name="description_ml" id="summernote2" ><?php echo e($about->description_ml); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="number" class="form-control" name="reviews" id="reviews" value="<?php echo e($about->reviews); ?>" />
                                            <?php $__errorArgs = ['reviews'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="number" class="form-control" name="awards" id="awards" value="<?php echo e($about->awards); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="number" class="form-control" name="products" id="products" value="<?php echo e($about->products); ?>" />
...
unset($__errorArgs, $__bag); ?>                                        
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="number" class="form-control" name="customers" id="customers" value="<?php echo e($about->customers); ?>" />
                                            <?php $__errorArgs = ['customers'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-5">
                                                    <img id="new_image1" src="<?php echo e(asset('frontend/assets/images/about/' . $about->image1)); ?>" style="width:400px;height:180px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-5">
                                                    <img id="new_image2" src="<?php echo e(asset('frontend/assets/images/about/' . $about->image2)); ?>" style="width:400px;height:180px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-5">
                                                    <img id="new_image3" src="<?php echo e(asset('frontend/assets/images/about/' . $about->image3)); ?>" style="width:400px;height:180px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-5">
                                                    <img id="new_image4" src="<?php echo e(asset('frontend/assets/images/about/' . $about->image4)); ?>" style="width:400px;height:180px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u147280632/domains/suzukipathanamthitta.com/public_html/resources/views/backend/about/edit.blade.php ENDPATH**/ ?>