            ...
            <div class="col-lg-12">
                <h3 class="ic-breadcrumb-title">
                    <?php if(session()->get('language') == 'Malayalam'): ?>
                        <?php echo e(is_null($subcategory) ? 'ആക്സസറികൾ' : $subcategory->name_ml); ?>

                    <?php else: ?>
                        <?php echo e(is_null($subcategory) ? 'Accessories' : $subcategory->name_en); ?>                           
                    <?php endif; ?>
                </h3>
                <ul>
                    <li>
                            ...
                            <div id="accordion" class="accordion">
                                <div class="card border-0">
                                    <div class="card-header">
                                        ...
                                        <h6 class="mb-0">                                          
                                            <a class="link-title" <?php echo e($category->slug == $subcategory->slug ? ' style=color:#D23B3B ' : ''); ?> href="<?php echo e(route('accessories.subcategory', $category->slug)); ?>" aria-expanded="true">
                                                <?php if(session('language') == 'Malayalam'): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u147280632/domains/suzukipathanamthitta.com/public_html/resources/views/frontend/accessory_category.blade.php ENDPATH**/ ?>