        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="ic-error-content">
                    <img src="<?php echo e(asset('frontend/assets/images/500.png')); ?>" alt="404-thumb">
                    <?php if(session()->get('language') == 'Malayalam'): ?>
                        <h3>ക്ഷമിക്കണം!</h3>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u147280632/domains/suzukipathanamthitta.com/public_html/resources/views/errors/500.blade.php ENDPATH**/ ?>