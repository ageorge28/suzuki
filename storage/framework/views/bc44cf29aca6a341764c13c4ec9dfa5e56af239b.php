<?php $__env->startSection('title'); ?>
    <?php if(session('language') == 'Malayalam'): ?>
        <?php echo e($site->name_ml); ?> | <?php echo e($category->name_ml); ?>

    <?php else: ?>
        <?php echo e($site->name_en); ?> | <?php echo e($category->name_en); ?>
            ...
            <div class="col-lg-12">
                <h3 class="ic-breadcrumb-title">
                    <?php if(session()->get('language') == 'Malayalam'): ?>
                        <?php echo e(is_null($category) ? 'മോട്ടോർസൈക്കിളുകളും ബൈക്കുകളും' : $category->name_ml); ?>

                    <?php else: ?>
                        <?php echo e(is_null($category) ? 'Motorcycles and Bikes' : $category->name_en); ?>                           
                    <?php endif; ?>
                </h3>
                <ul>
                    <li>
                            ...
                            <div id="accordion" class="accordion">
                                <div class="card border-0">
                                    <div class="card-header">
                                        <h6 class="mb-0">
                                            <a class="link-title" <?php echo e(request()->is('*' . $bikes->slug) ? ' style=color:#D23B3B ' : ''); ?> href="<?php echo e(route('motorcycles.category', $bikes->slug)); ?>" aria-expanded="true">
                                                <?php if(session('language') == 'Malayalam'): ?>
                                        ...
                                        <div class="card-body">
                                            <ul class="list-unstyled">
                                                <?php $__currentLoopData = $bikes_subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li> <a <?php echo e(request()->is('*' . $subcategory->slug) ? ' style=color:#D23B3B ' : ''); ?> href="<?php echo e(route('motorcycles.category', $subcategory->slug)); ?>">
                                                        <?php if(session('language') == 'Malayalam'): ?>
                                ...
                                <div class="card border-0">
                                    <div class="card-header">
                                        <h6 class="mb-0">
                                            <a class="link-title" <?php echo e(request()->is('*' . $scooters->slug) ? ' style=color:#D23B3B ' : ''); ?> href="<?php echo e(route('motorcycles.category', $scooters->slug)); ?>" aria-expanded="true">
                                                <?php if(session('language') == 'Malayalam'): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u147280632/domains/suzukipathanamthitta.com/public_html/resources/views/frontend/motorcycle_category.blade.php ENDPATH**/ ?>