...
@section('title')
    @if(session('language') == 'Malayalam')
        {{ $site->name_ml }} | മോട്ടോർസൈക്കിളുകളും ബൈക്കുകളും
    @else
        {{ $site->name_en }} | Motorcycles and Bikes
    @endif
@endsection
                            ...
                            <div id="accordion" class="accordion">
                                <div class="card border-0">
                                    <div class="card-header">
                                        <h6 class="mb-0">
                                            <a class="link-title" href="{{ route('motorcycles.category', $bikes->slug) }}" aria-expanded="true">
                                                @if(session('language') == 'Malayalam')
                                                    {{ $bikes->name_ml }}
                                                @else
                                                    {{ $bikes->name_en }}
                                ...
                                <div class="card border-0">
                                    <div class="card-header">
                                        <h6 class="mb-0">
                                            <a class="link-title" href="{{ route('motorcycles.category', $scooters->slug) }}" aria-expanded="true">
                                                @if(session('language') == 'Malayalam')
                                                    {{ $scooters->name_ml }}
                                                @else
                                                    {{ $scooters->name_en }}
