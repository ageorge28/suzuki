            ...
            <div class="col-lg-12">
                <h3 class="ic-breadcrumb-title">
                    @if(session()->get('language') == 'Malayalam')
                        {{ is_null($subcategory) ? 'ആക്സസറികൾ' : $subcategory->name_ml }}
                    @else
                        {{ is_null($subcategory) ? 'Accessories' : $subcategory->name_en }}                           
                    @endif
                </h3>
                <ul>
                    <li>
                            ...
                            <div id="accordion" class="accordion">
                                <div class="card border-0">
                                    <div class="card-header">
                                        ...
                                        <h6 class="mb-0">                                          
                                            <a class="link-title" {{ $category->slug == $subcategory->slug ? ' style=color:#D23B3B ' : '' }} href="{{ route('accessories.subcategory', $category->slug) }}" aria-expanded="true">
                                                @if(session('language') == 'Malayalam')
                                                    {{ $category->name_ml }}
                                                @else
                                                    {{ $category->name_en }}
