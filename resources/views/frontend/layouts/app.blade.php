...
<head>
    ...
    <meta property="og:site_name" content="{{ $site->name_en }}" />
    <meta name="google-site-verification" content="DOGOnefVYthkz6HJPuvl1WRNRjT9dS72v7qTFQgLfKQ" />
    <meta name="robots" content="index, follow" />
    <meta name="googlebot" content="index, follow">
    <link rel="apple-touch-icon" href="{{ asset('frontend/assets/images/' . $site->favicon) }}" />
    <link rel="icon" type="image/png" href="{{ asset('frontend/assets/images/' . $site->favicon) }}">
    ...
    <!-- Favicon Icon -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('frontend/assets/images/' . $site->favicon) }}">
        ...
        <div class="container">
            <div class="ic-search-form">
                <form action="#">
                    ...
                    <button type="submit" class="ic-search-submit"><i class="icofont-search"></i></button>
                </form>
            </div>
        </div>
        <div class="ic-search-close">
    ...
    <div class="ic-preloader">
        <div class="loading-wrapper">
            <div class="ic-preloader-grid">
                <img src="{{ asset('frontend/assets/images/loading.gif') }}" />
                {{-- <div></div>
                <div></div>
                <div></div>
                <div></div>
