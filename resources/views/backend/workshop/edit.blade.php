                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.workshop.update') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" class="form-control" name="title_en" id="title_ml" value="{{ $workshop->title_en }}" />
                                            @error('title_en')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" class="form-control" name="title_ml" id="title_ml" value="{{ $workshop->title_ml }}" />
                                            @error('title_ml')
                                                <div class="text-danger"><small>{{ $message }}</small></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-10">
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <img id="new_main_image" src="{{ asset('frontend/assets/images/workshop/' . $workshop->main_image) }}" style="width:230px;height:172px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <textarea id="summernote1" name="description_en">{{ $workshop->description_en }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <textarea name="description_ml" id="summernote2" >{{ $workshop->description_ml }}</textarea>
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-10">
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <img id="new_image1" src="{{ asset('frontend/assets/images/workshop/' . $workshop->image1) }}" style="width:400px;height:180px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-10">
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <img id="new_image2" src="{{ asset('frontend/assets/images/workshop/' . $workshop->image2) }}" style="width:400px;height:180px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-10">
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <img id="new_image3" src="{{ asset('frontend/assets/images/workshop/' . $workshop->image3) }}" style="width:400px;height:180px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-10">
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <img id="new_image4" src="{{ asset('frontend/assets/images/workshop/' . $workshop->image4) }}" style="width:400px;height:180px" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <textarea id="summernote3" name="contacts">{{ $workshop->contacts }}</textarea>
                                        </div>
                                    </div>
